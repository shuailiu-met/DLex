...
class Sgd(Optimizer):
    ...
    def calculate_update(self,weight_tensor,gradient_tensor):
        return weight_tensor - self.learning_rate * self.regularizer.calculate_gradient(weight_tensor) - self.learning_rate*gradient_tensor #in practice, gradient_tensor is the gradient of weights,which will update the weight
...
class SgdWithMomentum(Optimizer):
    ...
    def calculate_update(self,weight_tensor,gradient_tensor):# Vk needs to be updated and stored for the next use
        ...
        self.vk = vk_now
        return weight_tensor - self.learning_rate * self.regularizer.calculate_gradient(weight_tensor) +vk_now
...
class Adam(Optimizer):
    ...
    def calculate_update(self,weight_tensor,gradient_tensor):
        ...
        return weights_next - self.learning_rate * self.regularizer.calculate_gradient(weight_tensor)